...
join (values
  ('Vivienda', 'Arriendo', 1),
  ('Vivienda', 'Dividendo', 2),
  ('Vivienda', 'Gastos Comunes', 3),
  ('Vivienda', 'Celular', 4),
  ('Vivienda', 'Gas', 5),
  ('Vivienda', 'Electricidad', 6),
  ('Vivienda', 'Agua', 7),
  ('Vivienda', 'Internet', 8),
  ('Vivienda', 'Mantenimiento', 9),
  ('Vivienda', 'Otros suministros', 10),
  ('Vivienda', 'Nana', 11),
  ('Vivienda', 'Contribuciones', 12),
  ('Vivienda', 'Lavandería', 13),
  ('Vivienda', 'Otros - vivienda', 14),
